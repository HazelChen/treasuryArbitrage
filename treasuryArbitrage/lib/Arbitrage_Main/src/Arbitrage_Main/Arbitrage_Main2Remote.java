...
/**
 * The <code>Arbitrage_Main2Remote</code> class provides a Java RMI-compliant interface 
 * to the M-functions from the files:
 * <pre>
 *  E:\\nju\\2014花旗杯\\LHGroup\\OC by DJ\\Arbitrage_Main_D.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a 
 * <code>Arbitrage_Main2Remote</code> instance when it is no longer needed to ensure that 
 ...
 * generate RMI server proxy objects for instances of Arbitrage_Main.Arbitrage_Main2.
 */
public interface Arbitrage_Main2Remote extends Poolable
{
    /**
     ...
     */
    public Object[] Arbitrage_Main_D(int nargout, Object... rhs) throws RemoteException;
