...
/**
 * The <code>Arbitrage_Main1Remote</code> class provides a Java RMI-compliant interface 
 * to the M-functions from the files:
 * <pre>
 *  E:\\nju\\2014花旗杯\\LHGroup\\OC by WXY\\Arbitrage_Main_W.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a 
 * <code>Arbitrage_Main1Remote</code> instance when it is no longer needed to ensure that 
 ...
 * generate RMI server proxy objects for instances of Arbitrage_Main.Arbitrage_Main1.
 */
public interface Arbitrage_Main1Remote extends Poolable
{
    /**
     ...
     */
    public Object[] Arbitrage_Main_W(int nargout, Object... rhs) throws RemoteException;
