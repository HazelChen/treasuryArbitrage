...
/**
 * The <code>Close1Remote</code> class provides a Java RMI-compliant interface to the 
 * M-functions from the files:
 * <pre>
 *  E:\\nju\\2014花旗杯\\LHGroup\\OC by WXY\\close1.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>Close1Remote</code> 
 ...
 * generate RMI server proxy objects for instances of Arbitrage_Main.Close1.
 */
public interface Close1Remote extends Poolable
{
    /**
     * Provides the standard interface for calling the <code>close1</code> M-function 
     ...
     */
    public Object[] close1(int nargout, Object... rhs) throws RemoteException;
