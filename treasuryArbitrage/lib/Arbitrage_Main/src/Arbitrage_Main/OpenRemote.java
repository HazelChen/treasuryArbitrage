...
/**
 * The <code>OpenRemote</code> class provides a Java RMI-compliant interface to the 
 * M-functions from the files:
 * <pre>
 *  E:\\nju\\2014花旗杯\\LHGroup\\MATLABbyFXY\\open.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>OpenRemote</code> 
 ...
 * generate RMI server proxy objects for instances of Arbitrage_Main.Open.
 */
public interface OpenRemote extends Poolable
{
    /**
