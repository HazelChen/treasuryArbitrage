...
/**
 * The <code>getFlenRemote</code> class provides a Java RMI-compliant interface to the 
 * M-functions from the files:
 * <pre>
 *  E:\\nju\\2014»¨Æì±­\\fxy\\mygetFlen.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>getFlenRemote</code> 
 ...
 * generate RMI server proxy objects for instances of Arbitrage_Main.getFlen.
 */
public interface getFlenRemote extends Poolable
{
    /**
     * Provides the standard interface for calling the <code>mygetFlen</code> M-function 
     ...
     */
    public Object[] mygetFlen(int nargout, Object... rhs) throws RemoteException;
