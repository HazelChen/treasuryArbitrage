...
/**
 * The <code>Open1Remote</code> class provides a Java RMI-compliant interface to the 
 * M-functions from the files:
 * <pre>
 *  E:\\nju\\2014花旗杯\\LHGroup\\OC by WXY\\open1.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>Open1Remote</code> 
 ...
 * generate RMI server proxy objects for instances of Arbitrage_Main.Open1.
 */
public interface Open1Remote extends Poolable
{
    /**
     * Provides the standard interface for calling the <code>open1</code> M-function with 
     * 5 input arguments.  
     *
     ...
     */
    public Object[] open1(int nargout, Object... rhs) throws RemoteException;
