...
/**
 * The <code>Open2Remote</code> class provides a Java RMI-compliant interface to the 
 * M-functions from the files:
 * <pre>
 *  E:\\nju\\2014花旗杯\\LHGroup\\OC by DJ\\open2.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>Open2Remote</code> 
 ...
 * generate RMI server proxy objects for instances of Arbitrage_Main.Open2.
 */
public interface Open2Remote extends Poolable
{
    /**
     * Provides the standard interface for calling the <code>open2</code> M-function with 
     * 6 input arguments.  
     *
     ...
     */
    public Object[] open2(int nargout, Object... rhs) throws RemoteException;
