...
public class ArbitragePortfolioWu extends ArbitragePortfolio{
	...
	private ArrayList<ArbGroup> getData(){
		...
		return LiveData.getInstance().getArbGroups();		
	}
	...
	public void updatePage() {
		update(LiveData.getInstance().getArbGroups());
		if (chart1 != null) {
			chart1.update();
		}
		if (chart2 != null) {
