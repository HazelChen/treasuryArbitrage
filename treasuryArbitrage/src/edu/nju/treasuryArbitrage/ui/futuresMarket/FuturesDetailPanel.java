...
public class FuturesDetailPanel extends JPanel{
	...
	private void initSell() {
		...
		buyLabels[0] = new JLabel("ÂòÒ»"); 
		buyLabels[1] = new JLabel("Âò¶þ"); 
		buyLabels[2] = new JLabel("ÂòÈý"); 
		buyLabels[3] = new JLabel("ÂòËÄ"); 
		buyLabels[4] = new JLabel("ÂòÎå"); 
		...
		for (int i = 0; i < buyLabels.length; i++) {
			...
			buyLabels[i].setFont(new Font("Î¢ÈíÑÅºÚ", Font.PLAIN, 18));
	...
	private void initDetail1() {
		...
		detail1[0] = new JLabel("×ÜÊÖ");
		detail1[1] = new JLabel("×ò½á");
		detail1[2] = new JLabel("×î¸ß");
		detail1[3] = new JLabel("¾ù¼Û");
		detail1[4] = new JLabel("ÍâÅÌ");
		
		detail1[5] = new JLabel("ÏÖÊÖ");
		detail1[6] = new JLabel("¿ªÅÌ");
		detail1[7] = new JLabel("×îµÍ");
		detail1[8] = new JLabel("Õñ·ù");
		detail1[9] = new JLabel("ÄÚÅÌ");
	...
	private void initDetail2() {
		...
		detail2[0] = new JLabel("³Ö²Ö");
		detail2[1] = new JLabel("¹À½áËã");
		detail2[2] = new JLabel("Ôö²Ö");
		detail2[3] = new JLabel("½áËã¼Û");
